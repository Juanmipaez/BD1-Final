...
<h1 class="mt-3 fw-bold">Entidad análoga a ANIMAL (Método de pago)</h1>

<!-- FORMULARIO. Cambiar los campos de acuerdo a su trabajo -->
<div class="formulario p-4 m-3 border rounded-3">

    <form action="metodo_de_pago_insert.php" method="post" class="form-group">
...
<?php
// Importar el código del otro archivo
require("metodo_de_pago_select.php");
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <form action="metodo_de_pago_delete.php" method="post">
